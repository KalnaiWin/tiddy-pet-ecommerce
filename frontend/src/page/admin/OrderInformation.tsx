  ...
  return (
    <div className="w-full p-5 bg-slate-100 min-h-screen flex flex-col gap-5">
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex gap-5 md:text-sm text-xs">
          <button className="flex gap-2 items-center font-semibold bg-white border md:px-5 md:py-3 px-3 py-1 rounded-md hover:bg-orange-500 hover:text-white cursor-pointer">
            <Download />
            Export
          </button>
        </div>
      </div>
      <div className="w-full border rounded-md py-3 grid xl:grid-cols-7 grid-cols-4 gap-2 px-5 bg-orange-100">
        <div className="relative xl:col-span-3 col-span-4 bg-white rounded-md border md:text-sm text-xs">
          <input
            type="text"
          ...
          />
          <Search className="absolute top-0.5 left-1 font-thin text-slate-500 md:size-6 size-5" />
        </div>
        <div className="relative col-span-2 bg-white rounded-md border md:text-sm text-xs">
          <div className="relative col-span-4 rounded-md">
            ...
            <Filter className="absolute top-0.5 left-1 font-thin text-slate-500 md:size-6 size-5" />
          </div>
        </div>
        <div className="relative col-span-2 bg-white rounded-md border md:text-sm text-xs">
          <div className="relative col-span-4 rounded-md">
