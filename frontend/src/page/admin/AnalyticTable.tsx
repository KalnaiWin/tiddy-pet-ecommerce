...
import SkeletonDashboard from "../../components/common/(admin)/SkeletonDashboard";
...
const AnalyticTable = () => {
  ...
  return (
    <div className="flex flex-col bg-slate-200 min-h-screen relative pb-10">
      {createVoucher && (
        <div className="absolute-center w-full h-full bg-black/30 z-30">
          <div
            className="absolute md:translate-x-[35%] sm:translate-x-[20%] md:w-[60%] h-fit top-[10%] rounded-xl"
            ref={formCreate}
          >
            <XIcon
      ...
      {revenueStatus === "loading" ? (
        ...
        <>
          <div className="grid xl:grid-cols-4 grid-cols-2 w-full gap-2 px-5">
          ...
          <div className="flex gap-5 xl:flex-row flex-col px-5">
            <div className="xl:w-2/3 w-full">
          ...
          <div className="w-full flex flex-col px-5 relative">
